...
(function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.$anchor.each(function (index) {
                    ...
                    $this.data(plugin._name + "_target", plugin.$panel.eq(index)).data("index", index).attr({
                        id: _id,
                        role: "tab",
            ...
            hide: function hide(_except) {
                var plugin = this;
                plugin.$anchor.not(_except).each(function () {
                    var $panel = $(this).removeClass(plugin.options.activeClassName).attr({
                        "aria-selected": false,
                        title: ""
                    }).data(plugin._name + "_target").removeClass(plugin.options.activeClassName);
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            beforeChange: function beforeChange($activeItemEl) {
                var plugin = this,
            ...
            afterChange: function afterChange($activeItemEl) {
                var plugin = this,
            ...
            _open: function _open($targetAnchor) {
                var plugin = this;
                ...
                if (plugin.initialized && plugin.options.mode === "slide") {
                    $targetPanel.stop().slideDown(plugin.options.speed, plugin.options.easing, function () {
                        ...
                        if (plugin.options.autoScroll) {
                            $("html, body").stop().animate({
                                scrollTop: $targetAnchor.offset().top - plugin.options.autoScrollTop
                            }, 100);
                        }
                    });
                } else {
            ...
            _close: function _close($targetAnchor) {
                var plugin = this;
                var $targetItem = $targetAnchor.closest(plugin.options.itemEl),
                    $targetPanel = $("#" + $targetAnchor.attr("aria-controls"));
            ...
            _changeStatus: function _changeStatus($anchor, isOpen) {
                var plugin = this;
                $anchor.attr({
            ...
            setAria: function setAria() {
                ...
                plugin.$anchor.each(function (index) {
                    ...
                    $this.data(plugin._name + "_target", plugin.$panel.eq(index)).data("index", index).data("title", $.trim($this.text())).attr({
                        id: _id,
                        "aria-expanded": false,
            ...
            removeAria: function removeAria() {
                var plugin = this;
                plugin.$anchor.each(function (index) {
                    var $this = $(this);
                    $this.data(plugin._name + "_target", "").data("index", "").data("title", "").removeAttr("id aria-expanded aria-controls title");
                });
                plugin.$panel.each(function (index) {
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.$checkboxDisabeld = plugin.$element.find(plugin.options.checkboxEl).not("[aria-disabled=true], [data-exception]");
                ...
                plugin.$checkbox.each(function (idx) {
                    ...
                    if (this.hasAttribute("data-exception")) {
                        $this.find("input").attr("data-exception" , "");
                    }
                ...
                if (plugin.options.allCheckCtrl && plugin.options.defaultChecked) {
                    plugin.checked(plugin.$allCheckbox.not("[aria-disabled=true], [data-exception]"));
            ...
            checked: function checked($this, changeEvent) {
                var plugin = this;
            ...
            unchecked: function unchecked($this, changeEvent) {
                var plugin = this;
            ...
            allCheckAlone: function allCheckAlone($target, checkEvent) {
                var plugin = this;

                var _checkEvent = checkEvent === "noEvent" ? false : true;

                var $wrap = $target.closest(plugin.options.allSectionEl);
                var $checkboxList = $wrap.find(plugin.options.checkboxEl).not("[aria-disabled=true], [data-exception]");
                ...
                if ($target.find(plugin.options.hiddenEl).prop("checked")) {
                    ...
                    if ($wrap.find("[data-js=checkbox__all-ctrl]").attr("aria-checked") === "true") {
            ...
            allCheck: function allCheck($this) {
                var plugin = this;
            ...
            allChecking: function allChecking($this) {
                var plugin = this;
                var checkBasket = [];
                var $allSection = $this.closest(plugin.options.allSectionEl);
                $allSection.find(plugin.options.allEl).each(function () {
                ...
                if (checkBasket.indexOf(false) === -1) {
                    plugin.checked($allSection.find("[data-js=checkbox__all-ctrl]"), false);
                }
            },
            stateChecking: function stateChecking($this) {
                /* 2019-07-05 check callback 추가// */
                var plugin = this;
                var $wrap = $this.closest(plugin.options.allSectionEl);
                var $totalCtrl = $wrap.find("[data-js=checkbox__all-ctrl]");
                var $hiddenEl = $this.find(plugin.options.hiddenEl); // 전체선택 2depth (플랜트)

                var checkBoxLeng = plugin.$checkboxDisabeld.length,
                    checkLeng = plugin.$checkbox.find(plugin.options.hiddenEl + ":checked").not(":disabled, [data-exception]").length;
                ...
                var allLeng = $wrap.find(plugin.options.allEl).find(plugin.options.hiddenEl + ":checked").not(":disabled, [data-exception]").length;
            ...
            initialSetting: function initialSetting($target) {
                var plugin = this;
                ...
                if ($target.closest(".module-cart__li").length) {
                    var $title = $target.closest(".module-cart__li").find(".module-cart__title");
                    var matchId = $title.attr("id") ? $title.attr("id") : UTIL.uuid("js-" + pluginName + "-");
                    $target.attr("aria-labelledby", matchId);
                    $title.attr("id", matchId);
                }
            },
            removeSetting: function removeSetting() {
                var plugin = this;
        ...
        $.extend(Plugin.prototype, {
            ...
            checked: function checked($self) {
                ...
                $self.attr({
                    "tabindex": 0,
                    "aria-checked": true
                }).focus().find(plugin.options.hiddenEl).prop("checked", true).change();
                plugin.$radio.not($self).each(function () {
                    $(this).removeAttr('tabindex').attr({
                        "aria-checked": false
                    }).find(plugin.options.hiddenEl).prop("checked", false);
                });
            },
            initialSetting: function initialSetting() {
                var plugin = this;
                ...
                plugin.$radio.each(function (idx) {
                    ...
                    if ($this.attr("aria-disabled") === "true") {
                        ...
                        if ($this.find(plugin.options.hiddenEl).attr("checked") === "checked") {
                            $this.attr({
                                "aria-checked": true,
                                tabindex: 0,
                                "data-index": idx
            ...
            defaultEventKill: function defaultEventKill(e) {
                e.stopPropagation();
                e.preventDefault();
            },
            destroy: function destroy() {
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.$slide = plugin.$element.find(".carousel__item"); // var dots = document.getElementsByClassName("dot");
            },
            bindEvents: function bindEvents() {
                var plugin = this;
            ...
            indexCounting: function indexCounting(idx) {
                var plugin = this;
            ...
            currentSlide: function currentSlide(idx) {
                var plugin = this;
                plugin.showSlide(plugin.idx = idx);
            }
        });
        ...
        $(function () {// $('[data-js=carousel]').carousel();
        });
    })(jQuery, window, document, undefined);
    /* Plugin - Floating */
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.top = plugin.options.sectionInFloating === "single" ? plugin.$element.offset().top + plugin.$target.outerHeight() : plugin.$element.offset().top;
                plugin.bottom = plugin.options.sectionInFloating === "single" ? plugin.top + (plugin.$element.outerHeight() - plugin.$target.outerHeight()) : plugin.top + (plugin.$element.outerHeight() - plugin.options.top);
                ...
                plugin.$focusAnchor.each(function (idx) {
                    var $this = $(this);
                    $this.data(plugin._name + "_target", plugin.$focusTarget.eq(idx)).data("index", idx);
                });
            ...
            sectionFloating: function sectionFloating(scrTop) {
                var plugin = this;
            ...
            toggle: function toggle(toggleCase) {
                var plugin = this;
            ...
            unFloating: function unFloating() {
                var plugin = this;
                if (!plugin.flag) return;
            ...
            targetFoucs: function targetFoucs($self, target) {
                var plugin = this;
                var $anchor = $self;
                var flag = false;
                plugin.close();
            ...
            targetSwitch: function targetSwitch(scrollTop) {
                var plugin = this;
            ...
            activeClassCtrl: function activeClassCtrl($self) {
                var plugin = this;
            ...
            open: function open() {
                ...
                plugin.$body.addClass('is-opened').css('top', -plugin.$body.data('scrollTop')).data('top', plugin.$body.data('scrollTop'));
            },
            close: function close(anchorFlag) {
                var plugin = this;
            ...
            removeBodyScroll: function removeBodyScroll(anchorFlag) {
                var plugin = this;
            ...
            setIntervalScroll: function setIntervalScroll() {
                var plugin = this;
            ...
            perceiveScroll: function perceiveScroll() {
                var plugin = this;
                ...
                if (_scrollTop > plugin.lastScrollTop && _scrollTop > 50) {
                    ...
                    plugin.removePerceiveScroll(); // down
                } else {
            ...
            setPerceiveScroll: function setPerceiveScroll() {
                var plugin = this;
                var headerHeight = 0;
            ...
            removePerceiveScroll: function removePerceiveScroll() {
                var plugin = this;
            ...
            replaceText: function replaceText(target) {
                var plugin = this;
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.stickyHeight = plugin.$target.outerHeight() > 0 ? plugin.$target.outerHeight() : plugin.options.defaultHeight;
            ...
            bindEvents: function bindEvents() {
                ...
                plugin.$state.on("click." + plugin._name + " keydown." + plugin._name, function (e) {
                    var key = e.keyCode || e.which;
            ...
            toggle: function toggle(type) {
                var plugin = this;
                var sectionTop = plugin.getOffsetTop(plugin.$targetParent) - plugin.floatingHeight;
                var sectionBottom = plugin.getOffsetTop(plugin.$wrap) + plugin.$wrap.outerHeight() - (plugin.floatingHeight + plugin.stickyHeight);

                if (type == "dropdown") {
                    plugin.dropdownFlag ? plugin.close() : plugin.open();
                } else {
                    if (plugin.currentScrtop >= sectionTop && plugin.currentScrtop <= sectionBottom) {
                        plugin.fixed();
                    } else {
                        plugin.unFixed();
                    }
            ...
            open: function open() {
                var plugin = this;
                plugin.dropdownFlag = true;
                plugin.$state.addClass("is-open").attr("aria-expended", plugin.dropdownFlag);
            },
            close: function close() {
                var plugin = this;
                plugin.dropdownFlag = false;
                plugin.$state.removeClass("is-open").attr("aria-expended", plugin.dropdownFlag);
            },
            targetFocus: function targetFocus() {
                var plugin = this;
                $.each(plugin.$section, function (idx) {
                    var $this = $(this);
                    var result = Math.floor($this.offset().top) - (plugin.floatingHeight + plugin.stickyHeight);

                    if ($this.next().length) {
                        if (result <= plugin.currentScrtop && $this.next().offset().top > plugin.currentScrtop) {
            ...
            getfloatingHeight: function getfloatingHeight() {
                var plugin = this;
                plugin.floatingHeight = 0;
                $.each($("[data-js=floating__target]"), function () {
                    var $this = $(this);
                    plugin.floatingHeight += $this.outerHeight() > 50 ? 45 : $this.outerHeight();
                });
            },
            moveFocus: function moveFocus($target) {
                var plugin = this;
                var $focusTarget = $($target.attr("href"));
                plugin.$body.stop().animate({
                    scrollTop: $focusTarget.offset().top - (plugin.floatingHeight + plugin.stickyHeight)
                }, 200, function () {
                    $focusTarget.attr("tabindex", 0).focus();
                    setTimeout(function () {
                        plugin.$win.scrollTop($focusTarget.offset().top - ($target.data("js") === "sticky__top" ? 125 : 140));
                    });
                });
            },
            activeClass: function activeClass($this) {
                var plugin = this;
                plugin.$stateAnchor.not($this).removeClass(plugin.options.anchorActiveClassName);
            ...
            setAria: function setAria() {
                ...
                $.each(plugin.$stateAnchor, function (idx) {
                    $(this).text(plugin._afterBasket[idx]).attr("role", "option");
                });
            },
            removeAria: function removeAria() {
                var plugin = this;
                plugin.$title.removeAttr("id");
                plugin.$state.removeAttr("id aria-labelledby aria-haspopup aria-expended");
                plugin.$stateList.removeAttr("id role aria-labelledby");
                $.each(plugin.$stateAnchor, function (idx) {
                    $(this).text(plugin._beforeBasket[idx]).removeAttr("role");
                });
            }
        });
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.$panel = plugin.options.type !== "sticky" ? plugin.$element.find(plugin.options.panel).appendTo("body").attr("tabindex", 0) : plugin.$element.find(plugin.options.panel);
                plugin.$win = $(win);
            },
            bindEvents: function bindEvents() {
                var plugin = this;
            ...
            open: function open() {
                ...
                if (buttonLeft + panelWidth / 2 > winWidth) {
                    plugin.$panel.css({
                        top: buttonTop,
                        left: winWidth - panelWidth - 15 < 30 ? 15 : winWidth - panelWidth - 15,
                        display: "block",
                    ...
                    plugin.$panel.css({
                        top: buttonTop,
                        left: buttonLeft - panelWidth / 2 < 30 ? 15 : buttonLeft - panelWidth / 2,
                        display: "block",
                        position: plugin.$panel.is('.tooltip__pannel--sticky') ? "fixed" : ""
                    }).focus();
                }
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            setAccessibility: function setAccessibility() {
                var plugin = this;
                var focusElements = plugin.getFocusElements([".swiper-slide-duplicate", ".swiper-slide-duplicate *"]); // array or string
            ...
            getFocusElements: function getFocusElements(element) {
                var plugin = this;
            ...
            findFocusElements: function findFocusElements(element) {
                var plugin = this;
  ...
  */
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            bindEvents: function bindEvents() {
                ...
                $(doc).on("click." + plugin._name, plugin.options.datepickerSubmit, function (e) {
                    e.preventDefault();
                    var $target = $($(this).closest(plugin.options.modal));
            ...
            afterBindEvents: function afterBindEvents(focusElementFirst, focusElementLast) {
                var plugin = this;
            ...
            removeScrollTop: function removeScrollTop(val) {
                var plugin = this;
            ...
            open: function open(target) {
                ...
                $target.addClass(plugin.options.activeClassName).css("z-index", 300 + plugin._basket.indexOf(targetId)).attr({
                    role: "dialog",
                    "aria-modal": true
                }).focus().find(".slick-initialized").length && $target.find(".slick-initialized").slick("setPosition");
            ...
            close: function close(target, focusEl) {
                var plugin = this;
                var $target = $(target);
                var targetId = $target.attr("id");
            ...
            removeStyles: function removeStyles($target) {
                $target.css({
                    position: "",
                    overflow: "",
                    top: "",
            ...
            setStyles: function setStyles($target) {
                $target.css({
                    position: "fixed",
                    overflow: "hidden",
                    top: 0,
   ...
   */
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
                ...
                if (plugin.options.scroll) {
                    plugin.$win.on({
                        scroll: function scroll() {
                            ...
                            var currentOffset = plugin.videoOffset + plugin.$video.outerHeight() / 2;

                            if (plugin.videoOffset > 0 && scrBtm > currentOffset && scrTop < currentOffset) {
            ...
            getVideoOffset: function getVideoOffset() {
                var plugin = this;
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            buildCache: function buildCache() {
                ...
                plugin.flag = plugin.$stateButton.hasClass(plugin.options.buttonActiveClassName) ? true : false;
                plugin.columnFlag = plugin.$productList.hasClass(plugin.options.columnClassName) ? true : false;
                plugin.listFlag = plugin.$productList.find("li").length > 0 ? true : false;
            },
            bindEvents: function bindEvents() {
                var plugin = this;
            ...
            toggle: function toggle() {
                ...
                if (plugin.flag) {
                    plugin.flag = false;
                    plugin.$stateButton.removeClass(plugin.options.buttonActiveClassName).find(".blind").text(plugin.options.listText);
                    plugin.columnFlag && plugin.$productList.addClass(plugin.options.columnClassName);
                    plugin.$productList.removeClass(plugin.options.listClassName);
                } else {
                    plugin.flag = true;
                    plugin.$stateButton.addClass(plugin.options.buttonActiveClassName).find(".blind").text(plugin.options.thumbText);
                    plugin.columnFlag && plugin.$productList.removeClass(plugin.options.columnClassName);
   ...
   */
    ...
    (function ($, win, doc, undefined) {
        ...
        $.extend(Plugin.prototype, {
            ...
            bindEvents: function bindEvents() {
                ...
                plugin.$element.on((_plugin$$element$on = {}, _defineProperty(_plugin$$element$on, initEvent, function (e, slick) {
                    plugin.setCount(slick);
                    plugin.setTabindex(slick);
                }), _defineProperty(_plugin$$element$on, setPositionEvent, function (e, slick) {
                    plugin.removeTabindex(slick);
                    plugin.setTabindex(slick);
                }), _defineProperty(_plugin$$element$on, refreshEvent, function (e, slick) {//refresh
                }), _defineProperty(_plugin$$element$on, beforeEvent, function (e, slick) {
                    //before
                    plugin.setTabindex(slick);
                }), _defineProperty(_plugin$$element$on, afterEvent, function (e, slick, currentSlide) {
                    plugin.removeTabindex(slick);
                    plugin.changeCount(slick, currentSlide);
                    $('.slick-slide').find('[data-js=checkbox__hidden]').attr("tabindex", -1);
                }), _defineProperty(_plugin$$element$on, destroyEvent, function (e, slick) {//destroy
                }), _defineProperty(_plugin$$element$on, lazyLoadError, function (e, slick, image, imageSource) {
                    plugin.lazyLoadError(image);
                }), _plugin$$element$on));
            },
            removeTabindex: function removeTabindex(slick) {
                // Dots tabindex 제거
                var _slick = slick;
            ...
            setTabindex: function setTabindex(slick) {
                var _slick = slick;
                $('.slick-slide').find('[data-js=checkbox__hidden]').attr("tabindex", -1); // $('.slick-slide').not('.slick-current').find('.inventory-box').hide();
                // $('.slick-current').find('.inventory-box').show();
            },
            setCount: function setCount(slick) {
                ...
                if ($(slick.target).find(".video-box").length) {
                    $(slick.target).find(".video-box").each(function () {
                        $(this).height($(slick.target).height());
                    });
                }
            },
            changeCount: function changeCount(slick, currentSlide) {
                // Slide number counting
                var _options = slick.options;
                var $slick = slick.$slider.closest("[data-js=slick]");
            ...
            lazyLoadError: function lazyLoadError(image) {
                $(image).attr({
            ...
            $(win).load(function () {
                $("[data-js=scrollx-positioning]").each(function () {
                    ...
                    if ($wrap.length === 1 && item_length > 0) {
                        var total_width = 0;
                        var lp = Number($item.eq(0).css("padding-left").replace("px", "")); // first item padding-left
                        ...
                        if ($target.length == 0) {
                            ...
                            if ($target.length > 0) $target.closest("[data-js=scrollx-positioning__item]").eq(0);
                        } else {
                            $target = $target.eq(0);
                        }

                        if ($target.length > 0) {
                            var l = $target.position().left + Number($target.css("padding-left").replace("px", "")) + Number($target.css("margin-left").replace("px", ""));
                        ...
                        if (opt.tablemode) {
                            ...
                            var fn_tablemodechange = function fn_tablemodechange() {
    ...
    $(function () {
        ...
        firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // check IOS
        ...
        cjom.youtubeComponent = function () {
            ...
            $("[data-js=video-ctrl]").each(function () {
                ...
                function play() {
                    ...
                    _.addClass("is-play"); // $youtubeCover.hide();
                ...
                function stop() {
                    ...
                    _.removeClass("is-pause"); // $youtubeCover.show();
                ...
                function onPlayerStateChange(event) {
                    if (event.data === 0) {
                        //ENDED
                        $youtubeCover.removeClass("is-play"); // $youtubeCover.removeClass('is-buffering');
                ...
                function fullscreenChangeHandler() {
                    var isFullScreen = document.mozFullScreen || document.webkitIsFullScreen || document.msFullscreenElement != null;
                ...
                function onPlayerReady() {
                    ...
                    _.on("stop.youtube", stop); // if(!isIOS) {
                    ...
                    if (options.scrollPlay) {
                        $(window).on({
                            scroll: function scroll() {
                                ...
                                if (elementOffset > 0 && scrBtm > currentOffset && scrTop < currentOffset) {
                                    play();
                                } else {
                                    pause();
                                }
    ...
    function stopSwiper(obj) {
        $("[data-list-btn]").each(function () {
            $(this).off("click.listBtn").on("click.listBtn", function () {
                $(this).closest("[data-list-swper]").addClass("photo-list");
                $(this).closest(".modal__contents").addClass("modal__contents--black");
    ...
    function startSwiper() {
        $("[data-list-swper]").each(function () {
            $(this).find("li").off("click.listLi").on("click.listLi", function () {
                var idx = $(this).index();
                $(this).closest("[data-list-swper]").removeClass("photo-list");
                $(this).closest(".modal__contents").addClass("modal__contents--black");
                viewSwiper(idx);
            });
        });
            ...
            if ($slick.length) {
                ...
                $slick.on("beforeChange", function (event, slick, currentSlide, nextSlide) {
                    if (currentSlide != nextSlide) {
                        ...
                        var $currentSub = $wrap.find(slick.$slides.eq(currentSlide).find("[data-subtitles]").attr("data-subtitles"));

                        if ($currentSub.length) {
                            $currentSub.hide();
                            var $toggle__anchor = $currentSub.find("[data-js=toggle__anchor]");
                            if ($toggle__anchor.hasClass("is-active")) $toggle__anchor.trigger("click");
                        } //

                    }
                }).on("afterChange", function (event, slick, currentSlide) {
                    if (currentSlide != beforeSlide) {
                        var $before = slick.$slides.eq(beforeSlide); // youtube stop
                        ...
                        $before.find("[data-js=video-ctrl__mp4]").each(function () {
                            var $target = $(this);
                            var videoTag = $target.find("[data-js=video-ctrl__video]").get(0);
                            videoTag.pause();
   ...
   */
    ...
    cjom.reviewAnchor = {
        ...
        anchor :  function ($anchor) {
            var $anchorTop = $($anchor).offset().top - 100;
    ...
    cjom.allMenuCtrl = function () {
        return {
            ...
            open: function open() {
                ...
                $('[data-js="all-menus"]').addClass("is-active").attr("tabindex", 0).one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function () {
            ...
            close: function close() {
                ...
                $('[data-js="all-menus"]').removeClass("is-active").attr("tabindex", -1);
    ...
    cjom.datePicker = function () {
        if ($("[data-js=datepicker]")) {
            $("[data-js=datepicker]").each(function () {
                var $this = $(this);
                var customOptions = $this.data("options") || $this.data("datepicker-options");
                ...
                if (customOptions && customOptions.setDate) {
                    $this.datepicker($.extend({}, defaultOptions, customOptions)).datepicker("setDate", customOptions.setDate);
                } else {
        ...
        $("[data-js=modal-datepicker]").on("click", function () {
            ...
            var defaultDatepickerOptions = $modal.find(datepicker).data("datepicker-options");

            if (defaultDatepickerOptions) {
                $modal.find(datepicker).datepicker("setDate", defaultDatepickerOptions.setDate);
            } else {
            ...
            $modal.off("onCloseDatepicker").on("onCloseDatepicker", function () {
                $modal.datepicker("setDate", prevDate);
            }).off("onSubmitDatepicker").on("onSubmitDatepicker", function () {
        ...
        return {
            init: function init() {
                ...
                $("[data-js=carousel]").each(function () {
                    ...
                    var $this = $(this);
                    var options = $.extend({}, defaults, $this.data("options"), $this.hasClass("best") ? bestResponsive : {});

                    if (!$.data(this, "glider")) {
                        $.data(this, "glider", new Glider(_this.querySelector("[data-js=carousel__track]"), options, _this));
                    }
                });
            },
            refresh: function refresh(target) {
                var $target = $(target); // $target.data("glider").refresh();
            }
        };
    }();
    /*
  ...
  */
    ...
    $(function () {
        ...
        $(document).on("click", ".my-benefit__point-message-close", function () {
            $(this).parent(".my-benefit__point-message-box").hide();
    ...
    $(function () {
        $("[data-close-tooltop]").each(function () {
            ...
            $btn.off("click.tooltipClose").on("click.tooltipClose", function () {
                $(this).closest("[data-close-tooltop]").hide();
            });
        });
        cjom.openEvent();
    });
    ...
    cjom.addColumn = function () {
        ...
        return {
            ...
            addColumn: function addColumn($self) {
                $self.closest(defaults.element).find(defaults.item).not(".is-active").eq(0).addClass("is-active");
            },
            removeColumn: function removeColumn($self) {
                $self.closest(defaults.item).removeClass("is-active").appendTo(defaults.list).find("input[type=text]").val("");
            }
        };
    }();

    $(function () {
        $('.sticky-product__list').css({
            maxHeight: 218
        });
        $('.sticky-product__content').css({
            overflow: 'hidden',
            position: 'relative',
            display: 'block',
            width: 'auto',
        ...
        if (/Android/i.test(navigator.userAgent)) {
            $(document).on('focusin', focusTarget, function () {
                var $this = $(this);
            ...
            }).on('focusout', focusTarget, function () {// $('.modal__btn-box, [data-js=fixedButtonCtrl]').show();
                //
            });
        }

        var $fixedMenu = $('.fixed-menu__top'); //2019-07-10 뒤로가기버튼수정
